!function() {
    ...
    function() {
        ...
        h.template = function(e, t, n) {
            ...
            e.replace(i, function(t, n, i, o, s) {
                return a += e.slice(r, s).replace(S, C),
                r = s + t.length,
    ...
    define("utils/constants", {
        ...
        iframe_width: 433,
        iframe_height: 300,
        name_helper_url: "https://cdn.y8.com/Xd/name.html",
        xd_handler_helper_url: "https://cdn.y8.com/Xd/xd_handler.html?version=44",
        assetsRootUrl: function() {
            return "https://cdn.y8.com"
        },
        isEnv: function(e) {
            return "production" === e
        }
    ...
    function(e, t, n, i, r, a) {
        ...
        function u() {
            ...
            if (!b(navigator.plugins) && "object" == typeof navigator.plugins[e]) {
                ...
                n && !b(navigator.mimeTypes) && navigator.mimeTypes[t] && navigator.mimeTypes[t].enabledPlugin && (E = n.match(/\d+/g))
            }
            if (!E) {
                var i;
                try {
        ...
        function x(e) {
            b(C) && k();
            var n;
            C ? n = t.createElement('<iframe title="easyXDM" name="' + e.props.name + '"/>') : (n = t.createElement("IFRAME"),
            n.name = e.props.name,
            ...
            e.usePost) {
                ...
                "object" == typeof e.usePost)
                    for (var o in e.usePost)
                        e.usePost.hasOwnProperty(o) && (C ? r = t.createElement('<input name="' + o + '"/>') : (r = t.createElement("INPUT"),
                        r.name = o),
                        r.value = e.usePost[o],
                        a.appendChild(r));
                a.submit(),
        ...
        var C, E, R, N, j, L = this, O = Math.floor(1e4 * Math.random()), M = Function.prototype, D = /^((http.?:)\/\/([^:\/\s]+)(:\d+)*)/, P = /[\-\w]+\/\.\.\//, z = /([^:])\/\//g, H = "", B = {}, I = e.easyXDM, F = "easyXDM_", q = !1;
    ...
    function(e, t) {
        ...
        var Tt = function(e) {
            ...
            var k, x, _, T, A, S, C, E, R, N, j, L, O, M, D, P, z, H, B, I = "sizzle" + 1 * new Date, F = e.document, q = 0, U = 0, J = n(), W = n(), V = n(), X = function(e, t) {
                return e === t && (j = !0),
                0
            ...
            E = t.select = function(e, t, n, i) {
                ...
                return (u || C(e, c))(i, t, !D, n, !t || yt.test(e) && d(t.parentNode) || t),
                n
            }
            ,
        ...
        xt.fn.extend({
            ...
            is: function(e) {
                return !!o(this, "string" == typeof e && Ct.test(e) ? xt(e) : e || [], !1).length
            }
        });
            ...
            propHooks: {
                tabIndex: {
                    get: function(e) {
                        ...
                        return t ? parseInt(t, 10) : Sn.test(e.nodeName) || Cn.test(e.nodeName) && e.href ? 0 : -1
                    }
                }
            },
            propFix: {
            ...
            val: function(e) {
                var t, n, i, r = this[0];
                {
                    ...
                    if (r)
                        ...
                        "string" == typeof n ? n.replace(En, "") : null == n ? "" : n)
                }
            }
        }),
        xt.extend({
    ...
    function(e) {
        ...
        function w(e, t, n) {
            var i, r, a, o, s, l, u, b, w, x, _, T, A, S, C, E, R, N, j, L, O, M, D, P = [];
            ...
            _ = 0; x > _; _ += 1)
                ...
                P[_] = new M(b,w)) : P[_] = S(R(P[_ - 2]), P[_ - 7], E(P[_ - 15]), P[_ - 16]),
    ...
    define("multiplayer", ["logger"], function(e) {
        return {
            ...
            session: "",
            userid: "",
            nodes: [["playtomicmp1.ams3.y8.net", 3201], ["playtomicmp2.ams3.y8.net", 3201]],
            host: "",
            port: 0,
    ...
    define("ads_adsense", ["require", "utils/constants", "utils/scripts_loader", "utils/retry"], function(e) {
        ...
        return {
            ...
            bootstratp: function(e) {
                ...
                var t = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=" + this.config.adClient
                  , i = "Adsense";
                this.config.adHost && (t += "&host=" + this.config.adHost,
                i += " AFP"),
                i += ": ",
                ...
                var a = this
                  , o = new Date;
                console.log(i + "adConfig is called, measuring time until onReady callback"),
                adConfig({
                    preloadAdBreaks: "on",
                    sound: "on",
                    onReady: function() {
                        console.log(i + "Got onReady callback after", (new Date - o) / 1e3, "s"),
                        a.ready = !0,
            ...
            forEachScript: function(e) {
                ...
                this.config.adHost && e.setAttribute("data-ad-host", this.config.adHost),
                this.testMode() ? e.setAttribute("data-adbreak-test", "on") : this.config.adChannel && e.setAttribute("data-ad-channel", this.config.adChannel)
            },
            display: function(e) {
                var t = this;
    ...
    define("ads_strategy", ["require", "video_ad_settings", "ads_html5_ima", "ads_adsense", "utils/retry"], function(e) {
        ...
        return {
            ...
            bootstratp: function(e) {
                ...
                case "ad_sense":
                    this.strategy = i,
                    this.strategy.bootstratp("ad_afp" === e.ad_subprovider ? this.merge(this.config, {
                        adTiming: e.ad_timing,
                        adClient: e.afp_client,
